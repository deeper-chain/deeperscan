...
from app.settings import DB_CONNECTION, DEBUG, SUBSTRATE_RPC_URL, TYPE_REGISTRY, FINALIZATION_ONLY, TYPE_REGISTRY_FILE, DEEPER_DEBUG
...
def start_harvester(self, check_gaps=False):
    ...
    if check_gaps:
        ...
        for block_set in remaining_sets_result:
            ...
            end_block_hash = substrate.get_block_hash(block_to)
            start_block_hash = substrate.get_block_hash(block_from)

            # Start processing task
            print('start_harvester {}, {}, {}, {}'.format(start_block_hash, end_block_hash, block_from, block_to))
