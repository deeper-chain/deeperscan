...
CATCH_UP_BLOCKS_PER_RUN = int(os.environ.get("CATCH_UP_BLOCKS_PER_RUN", 500))
...
TYPE_REGISTRY = os.environ.get("TYPE_REGISTRY", "core")
...
SEARCH_INDEX_MICROPAYMENT_CLAIMPAYMENT = 40
SEARCH_INDEX_STAKING_DELEGATED = 41
SEARCH_INDEX_DEEPERNODE_IMONLINE = 42
SEARCH_INDEX_CREDIT_UPDATESUCCESS = 43
SEARCH_INDEX_RELEASE_REWARD = 44
SEARCH_INDEX_UNIQUES_TRANSFERRED = 45
SEARCH_INDEX_NPOW_MINT = 46
SEARCH_INDEX_SIGNED_EXTRINSIC = 99
SEARCH_INDEX_ADSCBALANCETRANSFER = 100 #ADSC index
