...
class GenericCall(ScaleType):
    ...
    def process(self):
        ...
        if self.metadata.portable_registry:
            ...
            if not self.call_module['calls'].value_object:
                return
            ...
            if self.call_function:
                ...
                call_function_name = self.call_function.name
            else:
                self.call_args = []
                call_function_name = ''
            ...
            return {
                'call_index': f'0x{self.call_index}',
                'call_function': call_function_name,
...
class ScaleInfoStorageEntryMetadata(GenericStorageEntryMetadata):
    ...
    def get_params_type_string(self):
        if 'Plain' in self.value['type']:
            ...
            if nmap_key_scale_type and nmap_key_scale_type.type_mapping:
...
class PreRuntime(GenericPreRuntime):
    pass

class ConsensusEngineId(GenericConsensusEngineId):
    pass

class Seal(GenericSeal):
    pass

class Consensus(GenericConsensus):
    pass
