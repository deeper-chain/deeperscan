...
# app.add_route('/deeper/transaction1', polkascan.TransactionResource())
app.add_route('/deeper/transaction', polkascan.TransactionResource2())
# app.add_route('/deeper/balance1', polkascan.BalanceResource())
app.add_route('/deeper/balance', polkascan.BalanceResource2())
app.add_route('/deeper/tax_report', polkascan.TaxReport())
app.add_route('/deeper/staking_delegate_count', polkascan.StakingDelegateCount())
app.add_route('/deeper/current_user_credit', polkascan.CurrentUserCredit())
app.add_route('/deeper/current_user_account', polkascan.CurrentUserAccount())
app.add_route('/deeper/current_user_release_time', polkascan.CurrentUserReleaseTime())
app.add_route('/deeper/oracle', polkascan.OracleResource())
app.add_route('/deeper/user_npow', polkascan.NpowResource())
app.add_route('/deeper/adsc_transfer', polkascan.ADSCAddressTransferHistoryResource())